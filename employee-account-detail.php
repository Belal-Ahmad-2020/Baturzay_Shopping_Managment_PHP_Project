    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Employee Account Detail</li>
            </ol>
        </div>
        <!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading text-center">Employee Account Detail</div>
...
?>
                            ...
                            <?php          
			  $id = $_GET['emp_id'];
			  $sql = "SELECT * FROM employee INNER JOIN users ON employee.employee_id = users.employee_id WHERE employee.employee_id=$id";
			  $emp = $con->query($sql);
			  $row = $emp->fetch_assoc();
